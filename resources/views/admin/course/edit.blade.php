    ...
    <div class="col-lg-12">
    	<div class="card">          
		    <div class="content" >              
		    	<!-- Content goes here -->
		    	<fieldset>
    	{!! Form::model($course, ['route' => [$globalvar['routeupdate'], $course->id], 'class' => 'form-horizontal', 'method' => 'PUT', 'data-parsley-validate' => '', 'enctype' => 'multipart/form-data', 'autocomplete' => 'off']) !!}
	    ...
	    <div class="col-md-8">
	            ...
	            <div class="content-box-large box-with-header">
	            	<div class="form-group">
			    		<label class="col-md-2 control-label" for="title">course Title:</label>
			    		<div class="col-lg-10">
			    			{!! Form::text('title', null, array('class' => 'form-control border-input', 'id' => 'title', 'placeholder' => 'Enter title here', 'required' => '', 'maxlength' => '255' )) !!}
			    		</div>
			    	</div>
			    	<div class="form-group">
			    		<label class="col-md-2 control-label" for="title">course Subject:</label>
			    		<div class="col-lg-10">
			    	...
			    	<div class="form-group">
			    		<label class="col-lg-3 control-label" for="image">course Image :</label>
			    		<div class="col-lg-3">
	    ...
	    <div class="col-md-4">
	            ...
	            <div class="content-box-large box-with-header">
	            	...
	            	<div>
	            		{!! Html::linkRoute($globalvar['routeindex'], 'Cancel', array($course->id), array('class' =>'btn btn-primary btn-block')) !!}

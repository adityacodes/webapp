						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li>
										<a href="{{url('template/mailbox-folder')}}">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{url('template/pages/signup')}}">
													 Sign Up
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/signin')}}">
													 Sign In
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/recover-password')}}">
													 Recover Password
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/lock-screen')}}">
													 Locked Screen
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/user-profile')}}">
													 User Profile
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/session-timeout')}}">
													 Session Timeout
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/calendar')}}">
													 Calendar
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/timeline')}}">
													 Timeline
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/media-gallery')}}">
													 Media Gallery
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/invoice')}}">
													 Invoice
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/blank')}}">
													 Blank Page
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/404')}}">
													 404
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/500')}}">
													 500
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/log-viewer')}}">
													 Log Viewer
												</a>
											</li>
											<li>
												<a href="{{url('template/pages/search-results')}}">
													 Search Results
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{url('template/ui/elements/typography')}}">
													 Typography
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/icons')}}">
													 Icons
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/tabs')}}">
													 Tabs
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/panels')}}">
													 Panels
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/widgets')}}">
													 Widgets
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/portlets')}}">
													 Portlets
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/buttons')}}">
													 Buttons
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/alerts')}}">
													 Alerts
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/notifications')}}">
													 Notifications
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/modals')}}">
													 Modals
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/lightbox')}}">
													 Lightbox
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/progressbars')}}">
													 Progress Bars
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/sliders')}}">
													 Sliders
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/carousels')}}">
													 Carousels
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/accordions')}}">
													 Accordions
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/nestable')}}">
													 Nestable
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/tree-view')}}">
													 Tree View
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/grid-system')}}">
													 Grid System
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/charts')}}">
													 Charts
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/animations')}}">
													 Animations
												</a>
											</li>
											<li>
												<a href="{{url('template/ui/elements/extra')}}">
													 Extra
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{url('template/forms/basic')}}">
													 Basic
												</a>
											</li>
											<li>
												<a href="{{url('template/forms/advanced')}}">
													 Advanced
												</a>
											</li>
											<li>
												<a href="{{url('template/forms/validation')}}">
													 Validation
												</a>
											</li>
											<li>
												<a href="{{url('template/forms/layouts')}}">
													 Layouts
												</a>
											</li>
											<li>
												<a href="{{url('template/forms/wizard')}}">
													 Wizard
												</a>
											</li>
											<li>
												<a href="{{url('template/forms/code-editor')}}">
													 Code Editor
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{url('template/tables/basic')}}">
													 Basic
												</a>
											</li>
											<li>
												<a href="{{url('template/tables/advanced')}}">
													 Advanced
												</a>
											</li>
											<li>
												<a href="{{url('template/tables/responsive')}}">
													 Responsive
												</a>
											</li>
											<li>
												<a href="{{url('template/tables/editable')}}">
													 Editable
												</a>
											</li>
											<li>
												<a href="{{url('template/tables/ajax')}}">
													 Ajax
												</a>
											</li>
											<li>
												<a href="{{url('template/tables/pricing')}}">
													 Pricing
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{url('template/maps-google-maps')}}">
													 Basic
												</a>
											</li>
											<li>
												<a href="{{url('template/maps-google-maps-builder')}}">
													 Map Builder
												</a>
											</li>
											<li>
												<a href="{{url('template/maps-vector')}}">
													 Vector
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent nav-expanded nav-active">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{url('template/layouts/default')}}">
													 Default
												</a>
											</li>
											<li class="nav-active">
												<a href="{{url('template/layouts/boxed')}}">
													 Boxed
												</a>
											</li>
											<li>
												<a href="{{url('template/layouts/menu-collapsed')}}">
													 Menu Collapsed
												</a>
											</li>
											<li>
												<a href="{{url('template/layouts/scroll')}}">
													 Scroll
												</a>
											</li>
										</ul>
									...
									<li>
										<a href="{{url('template/http://themeforest.net/item/porto-responsive-html5-template/4106987?ref=Okler" target="_blank')}}">
											...
											<div class="chart-data-selector" id="salesSelectorWrapper">
												...
												<div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
													...
													<script>
														...
														// See: 'admin/javascripts/dashboard/examples.dashboard.js for more settings.
										...
										<div class="col-lg-4 text-center">
											...
											<div class="liquid-meter-wrapper liquid-meter-sm mt-lg">
												<div class="liquid-meter">
													<meter min="0" max="100" value="95" id="meterSales"></meter>
												</div>
